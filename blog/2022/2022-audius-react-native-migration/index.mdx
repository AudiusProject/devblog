...
- The existing shared business logic module libs which has since been repurposed as the @audius/sdk
- Any code in the web app that referenced window, process.env, and a variety of other browser specific APIs
...
‍The move to React Native was a long and tedious process, but the results speak for themselves!